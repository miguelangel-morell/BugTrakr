...
{
    [DbContext(typeof(BugTrakrContext))]
    [Migration("20200617175524_TransferBugModelMigration")]
    partial class TransferBugModelMigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BugTrakr.Models.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BugTrakr.Models.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("BugTrakr.Models.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("BugTrakr.Models.AppUser", null)
                        .WithMany()
